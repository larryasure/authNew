  ...
  return (
    <>
      <div className="min-h-screen px-8 ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-white shadow-md rounded-2xl p-6 space-y-5 border border-gray-100">
              ...
              <div className="bg-green-50 rounded-xl p-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs">Income • Apr 2</p>
                  </div>
                </div>
              ...
              <div className="bg-red-50 rounded-xl p-4 flex items-center justify-between">
                ...
                {/* AMOUNT */}
                <p className="text-red-600 font-semibold text-sm">$5,000.00</p>
              </div>
        ...
        <div className="max-w-3xl mx-auto my-16 p-6 rounded-xl  bg-white  ">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 my-8">
            <div className=" border-gray  grid-cols-1  shadow-lg rounded-xl  bg-white   p-4">
              <div className="flex items-start gap-2 flex-col ">
                <p className=" my-1 font-semibold text-[var(--brand)]">
        ...
        <div className="bg-white/70 rounded-xl p-5 max-w-4xl mx-auto gap-9 sm:flex sm:flex-row flex-col items-center justify-center my-10">
          <div className="bg-white rounded-xl border border-gray-200 p-4 ">
            <div className="flex flex-col gap-1 items-center">
              <h1 className="text-[var(--brand)] text-4xl font-semibold">
                5k +
              </h1>
